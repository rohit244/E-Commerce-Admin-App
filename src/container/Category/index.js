...
import { IoIosCheckboxOutline, IoIosCheckbox, IoIosArrowDown, IoIosArrowForward, IoIosAdd, IoIosCloudUpload, IoIosTrash } from 'react-icons/io'
...
const Category = (props) => {
  ...
  const updateCategory = () => {
    updateCheckedAndExpandedCaegories();
    setUpdateCategoryModal(true);
  }

  const updateCheckedAndExpandedCaegories = () => {
